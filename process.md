...
- this document will be written to explain the reasoning behind each step.


# defining the scope 
i did my research with claude , i'll stick to python due to these reasons : 
- - shortage of time 
- - easy to develop an MVP
i will stick to full files reviewal for the moment 

# pipeline 
the pipeline will be composed of : 
...
This phase has no owner assigned in your framework yet. It warrants a decision because it splits cleanly between two sub-concerns that belong to different owners:
